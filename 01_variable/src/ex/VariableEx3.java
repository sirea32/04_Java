...
public class VariableEx3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("num2 : " + num2); // 123.456879
		System.out.println("result2 : " + result2); // 123
		
		// (자동 형변환)
		System.out.println(num2 - result2); // 0.456789
		//				   double  int   --->  double
		// -> 0.45678900000000056 (2진수 소수 표현시 문제점)(그래서 은행에서는 안쓰임 오차때문에)
		...
		System.out.println("경 번호 : " + (int)'경'); // 44221
		System.out.println("우 번호 : " + (int)'우'); // 50864
