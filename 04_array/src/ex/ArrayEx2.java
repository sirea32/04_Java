...
public class ArrayEx2 {
	...
	public void method2() {
		...
		// 깊은 복사 1 : for문 이용 // 깊은 복사는 원본과 똑같거나 더크게 하는것이 일반적이다?
	...
	*/
	...
	public void method3() {
		...
		// 위의 for문 아래 for문은 같은거다 위에꺼가 편하고 좋다
		// 향상된 무조건 접근하고 사용할때 일반for문은 선택해서 써야할떄
	...
	/** 1차원 배열
	 	...
	 	자료형[] 배열명 = new 자료형[크기]; 1차원
	 	자료형[][] 배열명 = new 자료형[크기][크기]; 2차원
	 */
	public void method5() {
		...
		System.out.println(arr[1]); // 1차원 배열의 해시코드(주소)가 나온다
