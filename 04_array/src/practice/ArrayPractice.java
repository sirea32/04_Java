...
//			if(arr[i] == search) {
//				System.out.println("인덱스 : " + i);
//				flag = ture; // 같은 값이 있으면 true로 변경
//			}
//		}
//		
//		 // flag == false 랑 같은데 세련되게 !로 한것
//        if (!flag) {
//            System.out.println("일치하는 값이 존재하지 않습니다.");
//        }
//		
...
//        
//        string ssn = sc.nextint();
//
//        // char 배열 생성 및 초기화
//        char[] ssnArray = ssn.toCharArray();
//
//        // 성별을 나타내는 숫자 이후부터 '*'로 변경
//        for (int i = 8; i < ssnArray.length; i++) {
//            ssnArray[i] = '*';
//        }
//
//        // char 배열을 문자열로 변환하여 출력
//        System.out.println(ssnArray);
//    }
