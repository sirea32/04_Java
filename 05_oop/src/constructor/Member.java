...
public class Member {
	...
	/* -- 작성 규칙 --
	 * 1. 반환형 없음(void, String, int ... 안씀) 반환형을 안쓴다는거임 
	 * 2. 생성자 이름은 클래스명과 동일
	 */
	
	/** 기본 생성자 
	 * - 매개 변수가 없는 생성자를 의미 소괄호가 없는 생성자를 의미?
	 * 
	 *  *중요*
	 * - 클래스에 생성자가 "하나도" 없을 경우
	 * 	 초월번역가인 컴파일러가 컴파일시 기본 생성자를 추가해줌
	 * 	 ex) public Member(){} 
	 * */
	public Member() { 
	...
	public Member(String memberId, String memberPw, String memberName, int memberAge) { // ** 오버로딩 적용!!! -> 매개변수의 개수가 다름
		// this : 여기이것 ㄴㄴ 의미는 맞지만 현재 객체라고 해야 있게보임
...
//	public String method)_{} // 반환형 다름 -> 중복 O
	 ...
	 *  *** 오버로딩 성립 조건 ***
	 *  1) 메서드의 이름이 똑같아야 한다
	 *  2) 매개 변수의 개수, 자료형, 자료형 순서 중 하나라도 달라야한다
	 * */
	
	public void method(int a) {} // 매개 변수 개수 다름
	public void method(int a, String b) {} // 매개 변수 다름
	public void method(String b, int a) {} // 자료형 순서 다름
	public void method(String b, long a) {} // 자료형 다룸
