...
public class StudentService {
	 ...
	 * 단, 수정된 자바 역량은 최대값(100), 최소값(0) 범위 초과가 불가
	 * @param std
	 */
	public void studyJava(Student std) {
		...
		// 100점(Student.MIN_VALUE) 초과시 Student.MIN_VALUE 대입
