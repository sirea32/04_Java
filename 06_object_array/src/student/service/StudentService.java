...
public class StudentService {
	...
	// 인덱스 : 0 ~ 4
	// 각 인덱스 요소 : 초기 값 null (처음에는 아무것도 참조하지 않은 상황이라 null이라 뜸)
	...
	public StudentService() {
		...
		students[0] = new StudentDTO("20240701", "짱구", '남');
		students[1] = new StudentDTO("20240702", "유리", '여');
		students[2] = new StudentDTO("20240703", "맹구", '남');
		
		// student[3] / [4] == null
		
		// 0 ~ 100 사이 난수 발생	  	  101인 이유는 0부터 시작이라
		// 1) Math.floor( Math.random() * 101 ) == 0 ~ 100
		
		// 2) Random random = new Random();
		//	  random.nexInt(101); == 0 ~ 100
	 ...
	 * @return true : 추가 성공시 / false : 추가 실패
