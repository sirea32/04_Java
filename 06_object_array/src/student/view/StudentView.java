...
public class StudentView {
	...
	// 필드 2개! 왠만한 view라면  이 두가지를 가지고 있을것이다!
	...
	public void mainMenu() {
		...
		do {
			...
			System.out.println("4. 학생 이름으로 조회"); // 동명이인 X // 이 프로그램에서는 동명이인이 없다고 가정하고 해보자는 의미로 씀
	...
	private void updateIndex() {
		...
		/* 학생이 존재하는 경우 */
		// 예) HTML, CSS, JS, Java 순서로 점수 입력 : 100 40 60 70
