 ...
 * 
 * 상속 키워드 : extends (확장하다)
 * 	-> 부모 모드를 물려받은 자식의 크기가 커지기 때문에!
 * 
 * ** 주의 사항 **
 * - 부모의 코드 중 생성자는 물려받지 못함!
 * 
 * - 부모의 private 접근 제한 필드/메서드는
 * 	 상속 받긴 하지만 직접 접근 불가!!!
...
public class Child1 extends Parent{
	...
	public void print() {
		...
		System.out.println("car : "      + getCar() ); // 간접 접근
